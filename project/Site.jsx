...
const { MalexLogo, MalexIcon, MalexIconTwo, Icon, Btn, Pill, Sticker } = window;
...
function ComoFunciona({ onReserve }) {
  return (
      ...
      <div className="phone-screen">
        ...
        <div className="ph-card">
          <div className="ph-card-row">
            ...
            <div>
              <div className="ph-card-t">Locker médio</div>
              <div className="ph-card-s">mala de bordo · 2 mochilas</div>
            </div>
          </div>
          <div className="ph-period">
            ...
            <div className="ph-period-col"><span className="ph-lbl">Saída</span><span className="ph-val">hoje · 17:30</span></div>
          </div>
        </div>
        <div className="ph-price">
          <div>
            <div className="ph-price-lbl">Total · até 4h</div>
            <div className="ph-price-val tabular">R$ 22</div>
          </div>
...
Object.assign(window, { Nav, Hero, Ticker, ComoFunciona, scrollToId });
